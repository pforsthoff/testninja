...
namespace TestNinja.Mocking
{
    public static class HousekeeperHelper
    {
        ...
        public static bool SendStatementEmails(DateTime statementDate, IFileSave fileSave, IEmailService emailService)
        {
            ...
            foreach (var housekeeper in housekeepers)
            {
                ...
                var statementFilename = fileSave.SaveStatement(housekeeper.Oid, housekeeper.FullName, statementDate);
                ...
                try
                {
                    emailService.EmailFile(emailAddress, emailBody, statementFilename,
